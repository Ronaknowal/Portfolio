...
Research/write packet prepared 2026-09-12; implemented 2026-09-22. The complete twelve-fit CPU experiment was rerun from this downloadable program, reproducing every decoded value in the retained record exactly. The website presents these saved measurements and separately computes bounded toy mechanisms live; it does not train the digit networks in the browser. The original prepared packet remains retained as historical authoring input.
