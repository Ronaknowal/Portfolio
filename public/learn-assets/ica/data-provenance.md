...
- Retained CSV: 20,000 data rows × 5 numeric columns, plus one header; 390,723 bytes; UTF-8/ASCII header, decimal integers, comma-delimited, CRLF lines. Every one of the 20,001 lines ends CRLF; the byte count and SHA-256 above are of exactly those bytes.
