...
export function ConfidenceCoverageLab() {
  ...
  return <section className="hypothesis-lab" data-lab="confidence-coverage" aria-label="Repeated confidence interval coverage">
    ...
    <p><strong>Inspect, then change:</strong> 25→100 observations shrinks the known-σ half-width by half. The standardized mean draws are shared until you request a new batch, so those means also move halfway toward 100 and the same rows still cover. That is a controlled comparison, not evidence that sample size cannot improve precision.</p>
