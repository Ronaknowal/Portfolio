...
export function NumericalDynamicsLab() {
  ...
  return <section className="dynamics-lab" aria-label="Numerical integration energy investigation"><h3>Did the system change, or did the numerical rule change?</h3><p>First test cooling: x′=−2x, x(0)=8. All updates run to t=6. Predict which step sizes make the Euler multiplier negative or give it magnitude at least one.</p><Choice label="Cooling integration step" numeric value={coolingStep} onChange={setCoolingStep} choices={[[0.25, 'h=0.25'], [0.5, 'h=0.5'], [1, 'h=1'], [1.5, 'h=1.5']]} />
