...
export function QueueAreaLab() {
  ...
  return <section className="queueing-lab" aria-label="Occupancy area investigation">
    <h3>Count rectangles, then count each job</h3><p>Predict what goes missing when the observation ends at 5 seconds. Select a job to identify its clipped contribution. These are exact finite traces, not simulated averages.</p>
