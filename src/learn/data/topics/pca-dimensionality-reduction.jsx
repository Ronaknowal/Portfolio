...
const pcaContent = {
  ...
  content: () => <div className="lesson-pilot pca-lesson">
    ...
    <Prose className="pca-route"><strong>First-pass route.</strong> Read sections 1 through 6, try the three labs in those sections and the first four programs as you meet them, then try practice 1 to 4 in section 9 and the readiness check in section 11. That takes you from a picture to a working analysis in about 50 minutes plus code time. Section 7 develops interpretation, section 8 connects PCA to clustering and prediction, and section 10 holds the deeper mathematics, computation and applications. Return to those when their questions become relevant.</Prose>
