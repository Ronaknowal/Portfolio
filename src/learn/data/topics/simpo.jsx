...
def length_normalized_logp(logits, token_ids, pad_id=0):
    ...
    return (token_logps * mask).sum(dim=-1), lengths       # (B,), (B,)`}
      ...
      <Prose>
        In real training you would typically pre-compute a response mask that covers only the completion tokens (not the prompt), not just non-pad tokens. For clarity this example uses padding-based masking; the principle is identical.
      </Prose>
