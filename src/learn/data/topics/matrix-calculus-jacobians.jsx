...
&\approx\nabla L(\theta)^\top v\end{aligned}`}</MathBlock>
      ...
      <Prose>PyTorch's <Code>torch.func.jvp</Code>, <Code>vjp</Code>, <Code>jacfwd</Code> and <Code>jacrev</Code> expose these choices. They are an optional next coding route in the official tutorial below; the complete runnable examples here use NumPy or the standard library and do not require PyTorch.</Prose>
