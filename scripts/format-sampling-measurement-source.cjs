...
const records = [];
for (const file of ['src/learn/data/topics/sampling-measurement-experimental-design.jsx', 'src/learn/components/lesson-labs/SamplingMeasurementLabs.jsx', 'src/learn/data/sampling-measurement-models.js', 'src/learn/data/curriculum/blueprints/sampling-measurement-experimental-design.js']) {
...
const cssFile = 'src/learn/components/lesson-labs/sampling-measurement-labs.css';
...
fs.writeFileSync('scratch/sampling-measurement-verification/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2) + '\n');
