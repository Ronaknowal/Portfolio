...
const records = [];
for (const file of [
  'src/learn/data/topics/recommender-systems-collaborative-filtering-matrix-factorization.jsx',
  'src/learn/components/lesson-labs/RecommenderLabs.jsx',
  'src/learn/components/lesson-labs/RecommenderFigures.jsx',
  'src/learn/data/recommender-models.js',
  'src/learn/data/curriculum/blueprints/recommender-systems-collaborative-filtering-matrix-factorization.js',
]) {
...
const file = 'src/learn/components/lesson-labs/recommender-labs.css';
...
records.push({ file, normalizedASTConserved: true });
fs.mkdirSync('scratch/recommender-review', { recursive: true });
fs.writeFileSync('scratch/recommender-review/format-conservation.json', JSON.stringify({ timestamp: new Date().toISOString(), records }, null, 2));
console.log('Five semantic source files formatted with normalized AST conservation.');
