...
const cssFile = 'src/learn/components/lesson-labs/concentration-inequality-labs.css';
...
fs.mkdirSync('scratch/concentration-verification', { recursive: true });
...
fs.writeFileSync('scratch/concentration-verification/formatting-results.json', JSON.stringify(result, null, 2));
