...
const files = [
  'src/learn/data/topics/causal-inference-do-calculus.jsx',
  'src/learn/data/causal-inference-models.js',
  'src/learn/data/causal-inference-examples.js',
  'src/learn/components/lesson-labs/CausalInferenceLabs.jsx',
  'src/learn/data/curriculum/blueprints/causal-inference-do-calculus.js',
];
...
const cssFile = 'src/learn/components/lesson-labs/causal-inference-labs.css';
...
fs.mkdirSync('scratch/causal-inference-verification', { recursive: true });
...
fs.writeFileSync('scratch/causal-inference-verification/formatting-results.json', JSON.stringify(result, null, 2));
