...
const dsaOwnership = {
  ...
  'arrays-strings-hash-maps': ['array-map-foundations-examples.js', 'array-map-foundations-model.js'],
  'linked-lists-stacks-queues': ['linked-foundations-examples.js', 'linked-foundations-model.js'],
  ...
  'dynamic-programming-states-transitions-optimization': ['dynamic-programming-examples.js', 'dynamic-programming-models.js'],
...
const mathematicsLessons = ['f-divergences-integral-probability-metrics', 'graph-fundamentals-adjacency-laplacian-connectivity', 'spectral-graph-theory', 'combinatorial-optimization-approximation-algorithms', 'causal-inference-do-calculus', 'entropy-cross-entropy-kl-divergence', 'mutual-information-information-bottleneck', 'rate-distortion-theory', 'variational-inference', 'exponential-families-sufficient-statistics', 'measure-theory-probability-spaces', 'optimal-transport-wasserstein-distance-sinkhorn', 'hypothesis-testing-confidence-intervals', 'bayesian-inference-conjugate-priors', 'concentration-inequalities-hoeffding-bernstein-chernoff', 'monte-carlo-methods-mcmc-metropolis-hastings-hmc-nuts', 'maximum-likelihood-map-estimation', 'constrained-multi-objective-optimization', 'probability-distributions-bayes-theorem', 'non-convex-optimization-landscape', 'second-order-methods-l-bfgs-k-fac-shampoo-natural-gradient', 'convex-duality-lagrangian-methods-kkt-conditions', 'vectors-matrices-tensor-operations', 'matrix-decompositions-svd-qr-cholesky-lu', 'eigenvalues-eigenvectors', 'matrix-calculus-jacobians', 'tensor-algebra-einsum-notation', 'randomized-linear-algebra', 'multivariate-calculus-gradients', 'convex-optimization', 'gradient-descent-variants-sgd-adam-adagrad-rmsprop-lamb-lars', 'learning-rate-schedules-cosine-warmup-onecyclelr'];
