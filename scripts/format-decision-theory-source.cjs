...
const records = [];
for (const file of [
  'src/learn/data/topics/decision-theory-risk-cost-sensitive-decisions.jsx',
  'src/learn/components/lesson-labs/DecisionTheoryLabs.jsx',
  'src/learn/components/lesson-labs/DecisionTheoryFigures.jsx',
  'src/learn/data/decision-theory-models.js',
  'src/learn/data/curriculum/blueprints/decision-theory-risk-cost-sensitive-decisions.js',
]) {
...
const file = 'src/learn/components/lesson-labs/decision-theory-labs.css';
...
records.push({ file, normalizedASTConserved: true });
fs.mkdirSync('scratch/decision-theory-review', { recursive: true });
fs.writeFileSync('scratch/decision-theory-review/format-conservation.json', JSON.stringify({ timestamp: new Date().toISOString(), records }, null, 2));
console.log('Six semantic source files formatted with normalized AST conservation.');
