...
const files = [
  ...
  'src/learn/data/external-memory-models.js',
  'src/learn/data/external-memory-examples.js',
  'src/learn/components/lesson-labs/ExternalMemoryLabs.jsx',
  'src/learn/data/curriculum/blueprints/external-memory-algorithms-b-trees-i-o-complexity.js',
  'src/learn/data/practice/external-memory-algorithms-b-trees-i-o-complexity.js',
];
...
const cssFile = 'src/learn/components/lesson-labs/external-memory-labs.css';
...
fs.mkdirSync('scratch/external-memory-verification', { recursive: true });
...
fs.writeFileSync('scratch/external-memory-verification/formatting-results.json', JSON.stringify(result, null, 2));
