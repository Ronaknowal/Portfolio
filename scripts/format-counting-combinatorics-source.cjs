...
const records = [];
for (const file of ['src/learn/data/topics/counting-combinatorics-mathematical-induction.jsx', 'src/learn/components/lesson-labs/CountingCombinatoricsLabs.jsx', 'src/learn/data/counting-combinatorics-models.js', 'src/learn/data/curriculum/blueprints/counting-combinatorics-mathematical-induction.js']) {
...
const file = 'src/learn/components/lesson-labs/counting-combinatorics-labs.css';
...
records.push({ file, normalizedASTConserved: true });
fs.mkdirSync('scratch/counting-combinatorics-verification', { recursive: true });
fs.writeFileSync('scratch/counting-combinatorics-verification/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2));
