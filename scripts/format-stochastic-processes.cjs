...
const files = [
  ...
  'src/learn/data/stochastic-processes-models.js',
  'src/learn/data/stochastic-processes-examples.js',
...
const cssFile = 'src/learn/components/lesson-labs/stochastic-processes-labs.css';
...
fs.writeFileSync('scratch/stochastic-processes-native-verification/formatting-results.json', JSON.stringify(result, null, 2));
