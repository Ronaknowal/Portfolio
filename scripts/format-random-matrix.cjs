...
const files = [
  'src/learn/data/topics/random-matrix-theory.jsx',
  'src/learn/data/random-matrix-models.js',
  'src/learn/data/random-matrix-examples.js',
  'src/learn/components/lesson-labs/RandomMatrixLabs.jsx',
  'src/learn/data/curriculum/blueprints/random-matrix-theory.js',
];
...
const cssFile = 'src/learn/components/lesson-labs/random-matrix-labs.css';
...
fs.writeFileSync('scratch/random-matrix-verification/formatting-results.json', JSON.stringify(result, null, 2));
