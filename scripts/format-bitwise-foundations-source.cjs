...
const records = [];
for (const file of ['src/learn/components/lesson-labs/BitwiseFoundationsLabs.jsx', 'src/learn/data/bitwise-foundations-models.js']) {
...
for (const cssFile of ['src/learn/components/lesson-labs/bitwise-foundations-labs.css']) {
...
fs.writeFileSync('scratch/bitwise-author/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2) + '\n');
console.log('Three owned source files formatted; semantic AST and JSX transforms conserved.');
