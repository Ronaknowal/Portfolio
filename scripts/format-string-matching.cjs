...
const files = [
  'src/learn/data/topics/string-matching-prefix-functions-rolling-hashes.jsx',
  'src/learn/data/string-matching-models.js',
  'src/learn/data/string-matching-examples.js',
  'src/learn/components/lesson-labs/StringMatchingLabs.jsx',
  'src/learn/data/curriculum/blueprints/string-matching-prefix-functions-rolling-hashes.js',
  'src/learn/data/practice/string-matching-prefix-functions-rolling-hashes.js',
];
...
const cssFile = 'src/learn/components/lesson-labs/string-matching-labs.css';
...
fs.mkdirSync('scratch/string-matching-verification', { recursive: true });
...
fs.writeFileSync('scratch/string-matching-verification/formatting-results.json', JSON.stringify(result, null, 2));
