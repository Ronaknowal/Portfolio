...
const cssFile = 'src/learn/components/lesson-labs/divergence-ipm-labs.css';
...
fs.writeFileSync('scratch/divergence-ipm-native-verification/formatting-results.json', JSON.stringify(result, null, 2));
