...
const records = [];
for (const file of ['src/learn/data/topics/topology-topological-data-analysis-tda.jsx', 'src/learn/components/lesson-labs/TopologyTdaLabs.jsx', 'src/learn/data/topology-tda-models.js', 'src/learn/data/curriculum/blueprints/topology-topological-data-analysis-tda.js']) {
...
fs.writeFileSync('scratch/topology-tda-review/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2) + '\n');
