...
const records = [];
for (const file of [
  'src/learn/data/topics/numerical-pdes-grids-finite-elements-stability.jsx',
  'src/learn/components/lesson-labs/NumericalPdeLabs.jsx',
  'src/learn/data/numerical-pde-models.js',
  'src/learn/data/curriculum/blueprints/numerical-pdes-grids-finite-elements-stability.js',
]) {
...
const file = 'src/learn/components/lesson-labs/numerical-pde-labs.css';
...
records.push({ file, normalizedASTConserved: true });
fs.mkdirSync('scratch/numerical-pde-review', { recursive: true });
fs.writeFileSync('scratch/numerical-pde-review/format-conservation.json', JSON.stringify({ timestamp: new Date().toISOString(), records }, null, 2));
