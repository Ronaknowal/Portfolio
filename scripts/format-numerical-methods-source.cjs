...
const records = [];
for (const file of ['src/learn/data/topics/numerical-methods-finite-differences-quadrature-root-finding.jsx', 'src/learn/components/lesson-labs/NumericalMethodsLabs.jsx', 'src/learn/data/numerical-methods-models.js', 'src/learn/data/curriculum/blueprints/numerical-methods-finite-differences-quadrature-root-finding.js']) {
...
const file = 'src/learn/components/lesson-labs/numerical-methods-labs.css';
...
fs.writeFileSync('scratch/numerical-methods-verification/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2));
