...
const records = [];
for (const file of ['src/learn/data/topics/single-variable-calculus-limits-derivatives-integrals.jsx', 'src/learn/components/lesson-labs/SingleVariableCalculusLabs.jsx', 'src/learn/data/single-variable-calculus-models.js', 'src/learn/data/curriculum/blueprints/single-variable-calculus-limits-derivatives-integrals.js']) {
...
const cssFile = 'src/learn/components/lesson-labs/single-variable-calculus-labs.css';
...
fs.writeFileSync('scratch/single-variable-calculus-review/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2) + '\n');
