...
const cssFile = 'src/learn/components/lesson-labs/combinatorial-optimization-labs.css';
...
fs.writeFileSync('scratch/combinatorial-optimization-review/formatting-results.json', JSON.stringify(result, null, 2));
