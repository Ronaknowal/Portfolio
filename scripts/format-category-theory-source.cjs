...
const records = [];
for (const file of ['src/learn/data/topics/category-theory-emerging-use-in-ml.jsx', 'src/learn/components/lesson-labs/CategoryTheoryLabs.jsx', 'src/learn/data/category-theory-models.js', 'src/learn/data/curriculum/blueprints/category-theory-emerging-use-in-ml.js']) {
...
const cssFile = 'src/learn/components/lesson-labs/category-theory-labs.css';
...
fs.writeFileSync('scratch/category-theory-review/format-conservation.json', JSON.stringify({ checkedAt: new Date().toISOString(), records }, null, 2) + '\n');
