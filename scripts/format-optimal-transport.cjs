...
const files = [
  ...
  'src/learn/data/optimal-transport-models.js',
  'src/learn/data/optimal-transport-examples.js',
  'src/learn/components/lesson-labs/OptimalTransportLabs.jsx',
...
const cssFile = 'src/learn/components/lesson-labs/optimal-transport-labs.css';
...
fs.mkdirSync('scratch/optimal-transport-verification', { recursive: true });
...
fs.writeFileSync('scratch/optimal-transport-verification/formatting-results.json', JSON.stringify(result, null, 2));
