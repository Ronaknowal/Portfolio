...
const cssFile = 'src/learn/components/lesson-labs/graph-fundamentals-labs.css';
...
fs.mkdirSync('scratch/graph-fundamentals-verification', { recursive: true });
...
fs.writeFileSync('scratch/graph-fundamentals-verification/formatting-results.json', JSON.stringify(result, null, 2));
