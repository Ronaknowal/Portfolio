...
const files = [
  'src/learn/data/topics/hashing-collision-resolution-amortized-analysis.jsx',
  'src/learn/data/hashing-amortized-models.js',
  'src/learn/components/lesson-labs/HashingAmortizedLabs.jsx',
  'src/learn/data/curriculum/blueprints/hashing-collision-resolution-amortized-analysis.js',
];
...
fs.mkdirSync('scratch/hashing-amortized-verification', { recursive: true });
...
fs.writeFileSync('scratch/hashing-amortized-verification/formatting-results.json', JSON.stringify(result, null, 2));
