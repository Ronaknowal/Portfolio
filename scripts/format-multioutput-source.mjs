...
const files = ['src/learn/data/topics/multi-label-multi-output-learning.jsx', 'src/learn/data/multioutput-models.js', 'src/learn/components/lesson-labs/MultioutputLabs.jsx', 'src/learn/components/lesson-labs/MultioutputFigures.jsx', 'src/learn/data/curriculum/blueprints/multi-label-multi-output-learning.js'];
...
const cssFile = 'src/learn/components/lesson-labs/multioutput-labs.css';
...
fs.writeFileSync('scratch/multioutput/format-conservation.json', JSON.stringify({ timestamp: new Date().toISOString(), files, normalizedAstConserved: true, cssFile, cssAstConserved: true, originalCssSha256: crypto.createHash('sha256').update(originalCss).digest('hex'), finalCssSha256: crypto.createHash('sha256').update(formattedCss).digest('hex') }, null, 2));
console.log('Formatted five semantic JavaScript sources and CSS; normalized ASTs conserved.');
