export default {
  ...
  sources: [{
    title: 'Hu, Koren and Volinsky: implicit feedback objective and ALS',
    url: 'https://yifanhu.net/PUB/cf.pdf'
  }, {
    title: 'Rendle et al.: Bayesian Personalized Ranking',
    url: 'https://arxiv.org/pdf/1205.2618'
  }, {
    title: 'Schnabel et al.: selection bias and recommendation evaluation',
    url: 'https://proceedings.mlr.press/v48/schnabel16.pdf'
  }, {
    title: 'Google Developers: matrix factorization visual introduction',
    url: 'https://developers.google.com/machine-learning/recommendation/collaborative/matrix'
  }, {
    title: 'Implicit CPU ALS API',
    url: 'https://benfred.github.io/implicit/api/models/cpu/als.html'
  }, {
    title: 'Surprise matrix-factorization API',
    url: 'https://surprise.readthedocs.io/en/stable/matrix_factorization.html'
  }, {
    title: 'Stanford CS246 public lecture archive: Recommender Systems I/II',
    url: 'https://snap.stanford.edu/class/cs246-videos-2019/'
  }]
};
