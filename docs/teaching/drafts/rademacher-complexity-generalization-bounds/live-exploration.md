...
Edit function rows, signs, feature vectors, norm budget and margins. Recompute best responses, enumerated averages, feature geometry and bound terms together. Stages organize the explanation; none asks for a guessed winner/value.
...
Runtime ownership: `src/learn/components/lesson-labs/RademacherLabs.jsx` and its topic-specific helpers. Current migration evidence: [Classical ML live exploration review](../../LIVE-EXPLORATION-CLASSICAL-LATE.md).
