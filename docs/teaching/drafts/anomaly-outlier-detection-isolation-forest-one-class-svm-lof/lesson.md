...
* [Liu, Ting and Zhou, Isolation Forest](https://cs.nju.edu.cn/zhouzh/zhouzh.files/publication/icdm08b.pdf). Read tree construction and path normalization in section 2, swamping and masking in section 3, then subsampling and the height limit in section 4.1. The experiments motivate choices rather than guarantee a universally optimal setting.
* [Breunig, Kriegel, Ng and Sander, LOF: Identifying Density-Based Local Outliers](https://sigmodrecord.org/publications/sigmodRecord/0006/pdfs/LOF_%20Identifying%20Density-Based%20Local%20Outliers.pdf). Sections 4 and 5 define reachability, tied neighborhoods and local bounds. Compare their possibly larger tied neighborhoods with our explicitly fixed-k calculation.
