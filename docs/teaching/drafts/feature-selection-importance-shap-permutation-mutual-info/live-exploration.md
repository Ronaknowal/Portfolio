...
Counts change mosaic areas and entropy bars; subset labels change the subset lattice; donor rows change permutation contributions; explanation/background edits change coalition paths and tree attribution. Keep zero-total validation and exact tree casting.
...
Runtime ownership: `src/learn/components/lesson-labs/SelectionLabs.jsx` and its topic-specific helpers. Current migration evidence: [Classical ML live exploration review](../../LIVE-EXPLORATION-CLASSICAL-LATE.md).
