...
Change priors, observations, graph edges, purchase decisions and treatment assignment. Display posterior/path/risk consequences directly. An unpurchased measurement and an unobserved reference label remain scientific missing-information states, not quiz answers.
...
Runtime ownership: `src/learn/components/lesson-labs/BayesNetLabs.jsx` and its topic-specific helpers. Current migration evidence: [Classical ML live exploration review](../../LIVE-EXPLORATION-CLASSICAL-LATE.md).
