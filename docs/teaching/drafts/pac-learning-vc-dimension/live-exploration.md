...
Change sample observations, candidate rules, target error and witness coordinates. Update version spaces, shattering witnesses and interval risks live. Empirical outcomes and formal guarantees remain separately labelled.
...
Runtime ownership: `src/learn/components/lesson-labs/PacLabs.jsx` and its topic-specific helpers. Current migration evidence: [Classical ML live exploration review](../../LIVE-EXPLORATION-CLASSICAL-LATE.md).
