...
- Resolution (2026-09-12): accepted in [prepared GP manuscript §9](../drafts/gaussian-processes-gp/lesson.md), with average-loss σ²=nλ, anchored Brownian RKHS and finite-rank qualification, and the fixed-feature-map/solve-cost distinction. [Design and source locators](../drafts/gaussian-processes-gp/design.md) record author research and checks. Status stays open because the live destination has not been implemented or independently reviewed; phase two must carry this prepared treatment into the lesson before closing the note.
