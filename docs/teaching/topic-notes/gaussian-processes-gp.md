...
- Preparation (2026-09-12): accepted in [prepared GP manuscript §9](../drafts/gaussian-processes-gp/lesson.md), with average-loss σ²=nλ, anchored Brownian RKHS and finite-rank qualification, and the fixed-feature-map/solve-cost distinction. [Design and source locators](../drafts/gaussian-processes-gp/design.md) record author research and checks.
- Closure (2026-09-19): all named treatments are present in the actual reader's deeper-connections section. The [implementation record](../drafts/gaussian-processes-gp/implementation.md) and [independent review](../GAUSSIAN-PROCESSES-INDEPENDENT-REVIEW.md) verify the matching mean with differing interpretation, Brownian sample-path counterexample and finite-rank qualification, frozen-feature map and separate feature/solve costs. This closes the destination obligation; it does not assert user acceptance or reopen the source lesson.
